baseline = load("SimResults/tire energy saving study - all tires (combined)/budapest_baseline/sim.mat");

saving_energy_10 = load("SimResults/tire energy saving study - all tires (combined)/budapest_90p_tire_energy/sim.mat");

saving_energy_20 = load("SimResults/tire energy saving study - all tires (combined)/budapest_80p_tire_energy/sim.mat");

saving_energy_30 = load("SimResults/tire energy saving study - all tires (combined)/budapest_70p_tire_energy/sim.mat");

saving_energy_40 = load("SimResults/tire energy saving study - all tires (combined)/budapest_60p_tire_energy/sim.mat");
...
%%
figure; plotbrowser;
energy_array = [baseline.KPIs.combined_sliding_energy_total saving_energy_10.KPIs.combined_sliding_energy_total ...
    saving_energy_20.KPIs.combined_sliding_energy_total saving_energy_30.KPIs.combined_sliding_energy_total...
    saving_energy_40.KPIs.combined_sliding_energy_total];
...
xlabel('Combined Sliding Energy (all 4 tires) [kJ]')
ylabel('Laptime [s]')
title('Laptime vs Combined Sliding Energy into the 4 tires')
