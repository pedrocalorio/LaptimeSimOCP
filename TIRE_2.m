...
function [mfCoeff] = TIRE_2(~)
    ...
    MF.scaling.lmux = 1.0;   % longitudinal friction scaling
    MF.scaling.lKx  = 1;   % longitudinal slip stiffness scaling
    MF.scaling.lmuy = 1.25;   % lateral friction scaling
    MF.scaling.lKy  = 1.0;   % cornering stiffness scaling
