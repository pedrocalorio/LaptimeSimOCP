function [dx,g_ineq,q_eq,O] = fnDynamicsVehicle_linear_tires(~,x,u,Vehicle,p)
...
%     [Fx4,Fy4,Mz4]  = Solver.MF5ss_eval(Fz4,kappa4,alpha4,0,MF_r);  
    Fx1 = 4e3*kappa1; Fx2 = 4e3*kappa2; Fx3 = 5e3*kappa3; Fx4 = 5e3*kappa4;
    Fy1 = 8e3*alpha1; Fy2 = 8e3*alpha2; Fy3 = 10e3*alpha3; Fy4 = 10e3*alpha4;
...
%     eigenvalues = eig(A_mat);

 
    g_ineq = zeros(8,length(x(1,:))); 
    g_ineq(1,:) = -C_x_1;
    g_ineq(2,:) = -C_x_2;
    g_ineq(3,:) = -C_y_1;
    g_ineq(4,:) = -C_y_2;
...
%     g_ineq(9:10,:) = eigenvalues;
    ...
    wheel_linear_speed_1 = omega1*Rl1;
    wheel_linear_speed_2 = omega1*Rl2;
    wheel_linear_speed_3 = omega1*Rl3;
    wheel_linear_speed_4 = omega1*Rl4;
