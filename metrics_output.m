...
% lateral
KPI.lateral_sliding_energy_1 = trapz(O(10,:))/1e3;
KPI.lateral_sliding_energy_2 = trapz(O(11,:))/1e3;
KPI.lateral_sliding_energy_3 = trapz(O(12,:))/1e3;
KPI.lateral_sliding_energy_4 = trapz(O(13,:))/1e3;
...
% longitudinal
KPI.long_sliding_energy_1 = trapz(O(14,:))/1e3;
KPI.long_sliding_energy_2 = trapz(O(15,:))/1e3;
KPI.long_sliding_energy_3 = trapz(O(16,:))/1e3;
KPI.long_sliding_energy_4 = trapz(O(17,:))/1e3;
