...
% optimal_weight_distribution = p_star(1);
% optimal_downforce_distribution = p_star(2);
% % optimal_long_load_transf_distribution = soln.grid.design(3);
% optimal_lat_load_transf_distribution = p_star(3);
% optimal_brk_bias = p_star(4);
...
figure; plotbrowser;
subplot(2,1,1)
plot(Track.sLap,(u_star(3,:)))
title('normalized longitudinal load transfer')
subplot(2,1,2)
plot(Track.sLap,(u_star(4,:)))
title('normalized lateral load transfer')
