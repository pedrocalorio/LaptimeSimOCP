baseline = load("SimResults/PORTIMAO_LMP2_OS_500_BASELINE/sim.mat");

saving_energy_15 = load("SimResults/PORTIMAO_LMP2_OS_500_BASELINE_SAVING_TIREENERGY_15p/sim.mat");

saving_energy_30 = load("SimResults/PORTIMAO_LMP2_OS_500_BASELINE_SAVING_TIREENERGY_30p/sim.mat");
...
% speed
figure; plotbrowser;
plot(Track.sLap,3.6.*baseline.O(9,:),'-','LineWidth',2,'Color',[1 0.2 0])
hold on
plot(Track.sLap,3.6.*saving_energy_15.O(9,:),'-','LineWidth',2,'Color','b')
plot(Track.sLap,3.6.*saving_energy_30.O(9,:),'-','LineWidth',2,'Color','g')
