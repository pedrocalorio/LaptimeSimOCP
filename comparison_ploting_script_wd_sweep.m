baseline = load("SimResults/budapest_wd_sweep_different_range_stabilityconstraint_50p_aerobal/sim.mat");
...
indep_var_array = [0.45 0.47 0.49 0.51 0.53];
...
figure; plotbrowser;
plot(indep_var_array*100,laptime_array,'-o')
xlabel('Weight Distribution [%]')
ylabel('Laptime [s]')
